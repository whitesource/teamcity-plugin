...
<l:settingsGroup title="Update White Source">
    ...
    <tr id="containerOverrideOrgToken" style="${showSettings ? '' : 'display: none;'}">
        <th>
            ...
            <bs:helpIcon iconTitle="Tokens can be found in the profile section of your account on White Source."/>
        </th>
        <td>
    ...
    <tr id="containerOverrideUserKey" style="${showSettings ? '' : 'display: none;'}">
        <th>
            Override user Key:
            <bs:helpIcon iconTitle="User Keys can be found under your profile section of your account on White Source."/>
        </th>
        <td>
